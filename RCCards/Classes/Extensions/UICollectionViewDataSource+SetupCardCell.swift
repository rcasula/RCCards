...
//    }
    ...
    public func dequeueReusableCardCell(for indexPath: IndexPath,
                                        cardController: RCCard,
                                        parentController: UIViewController) -> RCCardCell {
        let cell = self.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! RCCardCell
        ...
        if cell.cardContentView.subviews.count == 0 {
            ...
            cell.cardContentView.addSubview(cardView)
...
//        self.register(CardCell.self, forCellWithReuseIdentifier: "cell")
        self.register(RCCardCell.self, forCellWithReuseIdentifier: "cell")
    }
